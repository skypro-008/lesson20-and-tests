...
# В переменной values находится список python представленный в
# байтах и в ней содержится список из 4 значений.
# Но сейчас кто-то перепутал индексы значения values.
# Вам необходимо написать 4 теста каждый из которых проверил бы правильность
# утверждения в функции summer
#
